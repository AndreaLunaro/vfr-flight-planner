...
class VFRFlightPlanner {
    ...
    changeAircraft(aircraftType) {
        ...
        // Set empty weight and its moment
            ...
            row.innerHTML = `
                ...
                <td>
                    <input type="number" 
                           ...
                           data-index="${index}"
                           value="${this.weightBalanceData.weights[index]?.toFixed(2) || 0}"
    ...
    // ===== WEIGHT & BALANCE METHODS (COMPLETI) =====
                    ...
                    tooltip: {
                        callbacks: {
                            label: function(context) {
                                const config = context.chart.$_aircraftConfig;
                                if (!config) return '';
        ...
        // Store config reference for tooltip
        this.weightBalanceData.chart.$_aircraftConfig = config;
    }
    ...
    updateWeightBalanceChart() {
        ...
        // Update config reference for tooltip
        this.weightBalanceData.chart.$_aircraftConfig = config;
